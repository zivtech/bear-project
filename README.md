...
```
Composer will create a new directory called MY_PROJECT containing a ```docroot``` directory with a full Bear code base therein. You can then install it like you would any other Drupal site.
